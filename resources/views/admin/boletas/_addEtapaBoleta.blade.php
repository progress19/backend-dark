  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-3">
          <div class="form-group">
            {!! Form::label('fechaEtapa', 'Fecha') !!}
            {!! Form::text('fechaEtapa', Carbon::now()->format('d-m-Y'), array('class' => 'form-control datespicker','id' => 'fechaEtapa')) !!}      
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            {!! Form::text('vencimiento', null, array('class' => 'form-control datespicker','id' => 'vencimiento')) !!}
          </div>
        </div>  
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            {!! Form::number('importe', null, ['id' => 'importe', 'class' => 'form-control']) !!}
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="form-group">
            {!! Form::label('obsEtapa', 'Observaciones') !!}
            {!! Form::textarea('obsEtapa', null, ['id' => 'obsEtapa', 'class' => 'form-control']) !!}
          </div>
        </div>
