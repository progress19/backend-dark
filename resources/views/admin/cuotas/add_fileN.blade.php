...
<div class="col-md-12">
  <div class="x_panel">
    <div class="x_title">
      <h2><i class="fa fa-bars"></i> Proceso de archivo de pagos - <b>BANCO NACION</b><small></small></h2>
      ...
      reader.addEventListener("loadend", 
         ...
         function(event) {
          ...
          $.ajax({
            ...
            success: function (data){
                //$('#divResult').html(data);
                console.log("File has been successfully (N)...!!");
            },
              error: function(e) {console.log(e);}}
            );
        } 
